...
const RegisterExit = () => {
  ...
  const [activeMenuItem, setActiveMenuItem] = useState('exit');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (exitQuantity > oldQuantity) {
        setError('Quantidade de saída maior que o estoque atual.');
        setLoading(false);
        return;
      }
      const newQuantity = oldQuantity - exitQuantity;
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="p-6 md:p-10">
          <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
            <h1 className="text-2xl font-semibold text-center text-black mb-6">Registrar Saída de Produto</h1>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4 flex items-center gap-4">
                  <div className="flex-1">
                    <label htmlFor="quantity" className="block text-sm font-medium text-gray-700 mb-1">Quantidade de saída:</label>
                    <input
                      type="number"
                      id="quantity"
